                ...
                <div className={`${styles.toggle__container} container d-flex justify-content-center`}>
                    <div className={styles.employer__area}>
                        ...
                        <ol>
                            ...
                            <li>We promote each role to targeted audiences. We use the Talentdrop network for general roles, where we already trust people to refer high-caliber talent. We also encourage you to share the posting with your broader network.</li>
                        ...
                        <div className="mx-3">
                            <span>* This is what bounty hunters will see on our board, and what they will be paid (in full) if they refer someone whom you hire. <b>Talentdrop fees are 25% of the posted bounty</b> for running the marketplace and vetting candidates.</span>
                            <br />
                            <br />
                            <span>

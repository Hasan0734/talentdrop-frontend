                            ...
                            <div className="row pt-5">
                                <div className='col-12 mb-5 text-center'>
                                    <div className={styles.card__body}>
                                        ...
                                        <br />
                                        <p>Talentdrop fees are <span className={styles.card__title}>25%</span> of your proposed bounty.</p>
                                    </div>
                                </div>
                                <div className='col-12 col-sm-6'>
                                    <div className={styles.card__body}>
                                        ...
                                        <br />
                                        <p><b>Scenario B:</b> Your role is filled directly by our Talentdrop network. We would only collect the bounty amount and waive the 25% fee.</p>
                                    </div>
                                </div>
